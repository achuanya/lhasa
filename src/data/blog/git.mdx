...
slug: git
ogImage: https://cos.lhasa.icu/ArticlePictures/git.jpg
tags:
  - Git
  - 分布式
...
<Img src={`${IMAGES}/flow%20chart.jpg`} alt="Git 数据流程图" />
...
<Img src={`${IMAGES}/rename.png`} alt="重命名操作" />
...
<Img src={`${IMAGES}/terminology.png`} alt="Git 专业术语中英文对照表" />
