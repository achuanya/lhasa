!(function (e, t) {
    ...
    try {
      ...
      return i < 0
        ...
        : i < 8
          ? `${i} ${t("days")}`
          : (function (e) {
              const t = f(e.getDate(), 2),
                n = f(e.getMonth() + 1, 2);
              return `${f(e.getFullYear(), 2)}-${n}-${t}`;
            })(e);
    } catch (n) {
  ...
  function E(e) {
    return (
      ...
      x[e] ? x[e] : window[b] && window[b][e] ? window[b][e] : x.en
    );
  }
  let C = "en",
    S = E(C);
  function T(e, t = {}) {
    let n = (null == S ? void 0 : S[e]) || e;
    return (n = n.replace(/\{\s*(\w+?)\s*\}/g, (e, n) => t[n] || "")), p(n);
  }
  function A() {
    return {
      async: !1,
  ...
  function _(e, t) {
    if (t) {
      if (M.test(e)) return e.replace(R, q);
    } else if (I.test(e)) return e.replace(U, q);
    return e;
  }
  const O = /(^|[^\[])\^/g;
  function D(e, t) {
    ...
    const s = {
      replace: (e, t) => {
        ...
        return (i = i.replace(O, "$1")), (n = n.replace(e, i)), s;
      },
  ...
  function N(e, t, n, s) {
    ...
    return { type: "image", raw: n, href: i, title: r, text: _(o) };
  }
  class H {
    constructor(e) {
      d(this, "options"),
    ...
    url(e) {
      ...
      if ((s = this.rules.inline.url.exec(e))) {
        ...
        if ("@" === s[2]) (e = _(s[0])), (i = "mailto:" + e);
          ...
          (e = _(s[0])), (i = "www." === s[1] ? "http://" + s[0] : s[0]);
        }
        return {
          type: "link",
          raw: s[0],
    ...
    inlineText(e) {
      ...
      if (t) {
        let e;
        return (
          (e = this.lexer.state.inRawBlock ? t[0] : _(t[0])),
  ...
  const V =
    ...
    le = /^( {2,}|\\)\n(?!\s*$)/,
    ce = "\\p{P}\\p{S}",
    de = D(/^((?![*_])[\spunctuation])/, "u")
      .replace(/punctuation/g, ce)
      .getRegex(),
    he = D(
    ...
    me = D(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/)
      ...
      .getRegex(),
    fe = D(ee).replace("(?:--\x3e|$)", "--\x3e").getRegex(),
    ke = D(
    ...
    be = {
      ...
      punctuation: de,
      reflink: we,
      reflinkSearch: D("reflink|nolink(?!\\()", "g")
        .replace("reflink", we)
        .replace("nolink", $e)
        .getRegex(),
      tag: ke,
    ...
    Se = { normal: se, gfm: re, pedantic: oe },
    Te = { normal: be, gfm: Ee, breaks: Ce, pedantic: xe };
  class Ae {
    constructor(e) {
      d(this, "tokens"),
        d(this, "options"),
        ...
        (this.options = e || L),
        (this.options.tokenizer = this.options.tokenizer || new H()),
        (this.tokenizer = this.options.tokenizer),
        (this.tokenizer.options = this.options),
        (this.tokenizer.lexer = this),
        (this.inlineQueue = []),
        (this.state = { inLink: !1, inRawBlock: !1, top: !0 });
      const t = { block: Se.normal, inline: Te.normal };
      this.options.pedantic
        ? ((t.block = Se.pedantic), (t.inline = Te.pedantic))
        : this.options.gfm &&
          ((t.block = Se.gfm),
          this.options.breaks ? (t.inline = Te.breaks) : (t.inline = Te.gfm)),
        (this.tokenizer.rules = t);
    }
    static get rules() {
      return { block: Se, inline: Te };
    }
    static lex(e, t) {
  ...
  class Le {
    constructor(e) {
      d(this, "options"), d(this, "parser"), (this.options = e || L);
    }
    space(e) {
      return "";
    }
  ...
  class Re {
    constructor(e) {
      d(this, "options"), d(this, "block"), (this.options = e || L);
    }
    preprocess(e) {
      return e;
    }
  ...
  class Ie {
      ...
      return (
        e.forEach(e => {
          ...
          if (
            ...
            const t = this.defaults.renderer || new Le(this.defaults);
          ...
          if (e.tokenizer) {
            const t = this.defaults.tokenizer || new H(this.defaults);
    ...
    lexer(e, t) {
      return Ae.lex(e, null != t ? t : this.defaults);
    }
    parser(e, t) {
      return Me.parse(e, null != t ? t : this.defaults);
    }
    parseMarkdown(e) {
      return (t, n) => {
        const s = l({}, n),
        ...
        const o = i.hooks ? i.hooks.provideLexer() : e ? Ae.lex : Ae.lexInline,
          a = i.hooks ? i.hooks.provideParser() : e ? Me.parse : Me.parseInline;
        if (i.async)
    ...
    onError(e, t) {
      return n => {
        if (
          ...
          const e =
            "<p>An error occurred:</p><pre>" + _(n.message + "", !0) + "</pre>";
  ...
  (je.options = je.setOptions =
    function (e) {
      return Ue.setOptions(e), (je.defaults = Ue.defaults), P(je.defaults), je;
    }),
    (je.getDefaults = A),
    (je.defaults = L),
    (je.use = function (...e) {
      return Ue.use(...e), (je.defaults = Ue.defaults), P(je.defaults), je;
    }),
    (je.walkTokens = function (e, t) {
      return Ue.walkTokens(e, t);
    }),
    (je.parseInline = Ue.parseInline),
    (je.Parser = Me),
    (je.parser = Me.parse),
    (je.Renderer = Le),
    (je.TextRenderer = Pe),
  ...
  function ze(e) {
    return null == e ? "" : String(e).replace(Be, Fe);
  }
  function Ne(e) {
    return null == e ? "" : String(e).replace(De, We);
  }
  ze.options = Ne.options = {};
  var He = {
    encode: ze,
    escape: ze,
    decode: Ne,
    ...
    ht = function (e, t) {
      ...
      function a(e, n, i, r) {
        var o = {},
          a = Je(n),
          l = et.voids[a] || !!r;
        i.replace(st, function (e, t, n, s, i) {
          o[t] =
            ...
            i("<"),
              ...
              Object.keys(t).forEach(function (e) {
                ...
                ("class" === l && -1 === o.indexOf(l)
                  ...
                  (i(" "),
                  i(e),
                  "string" == typeof n && (i('="'), i(ot.encode(n)), i('"')));
              }),
              i(o ? "/>" : ">");
          },
          end: function (e) {
  ...
  const vt = qe(yt.exports);
  function wt(e) {
    return vt(e);
  }
  function $t(e) {
    const t = new je.Renderer();
    return (
      (t.link = bt(t, t.link)),
      (t.code = xt()),
      (t.image = Et(t, t.image, e)),
      t
    );
  }
  const bt = (e, t) => n => {
  ...
  let Ct,
    St = [];
  const Tt = { gfm: !0, breaks: !0, async: !1 };
  function At() {
    return Ct;
  }
  function Lt(e) {
    var t;
    let n = null == (t = At()) ? void 0 : t.parse(e);
    n ||
      (n = (function (e) {
        return e
          .replace(
            /```\s*([^]+?.*?[^]+?[^]+?)```/g,
            (e, t) => `<pre><code>${wt(t)}</code></pre>`
          )
          .replace(
            /!\[(.*?)\]\((.*?)\)/g,
  ...
  class Pt {
      ...
      d(
        ...
        (function () {
          const e = new Map(),
            ...
            n = s => {
              const i = e.get(s);
              if (!i) throw new Error(`No provide for ${String(s)}`);
              if ("singleton" === i.lifecycle && t.has(s)) return t.get(s);
              const { impl: r, deps: o } = i,
                a = r(...o.map(e => n(e)));
              return t.set(s, a), a;
            };
          return {
            provide: (t, n, s, i = {}) => {
              e.set(t, {
                impl: n,
                deps: s || [],
                lifecycle: i.lifecycle || "singleton",
              });
            },
            inject: n,
          };
        ...
        d(this, "provide", (e, t, n, s) => {
          this._deps.provide(e, t, n, s);
        }),
        d(this, "inject", e => this._deps.inject(e)),
        d(this, "get", this.inject),
        d(this, "on", (e, t) => {
          this.inject("events").on(e, t);
        }),
        d(this, "off", (e, t) => {
          this.inject("events").off(e, t);
        }),
        d(this, "trigger", (e, t) => {
          this.inject("events").trigger(e, t);
        }),
    ...
    destroy() {
      for (this.trigger("unmounted"); this._$root.firstChild; )
    ...
    updateConf(e) {
      this.inject("config").update(e);
    }
    watchConf(e, t) {
      this.inject("config").watchConf(e, t);
    }
    getMarked() {
      return At();
    }
    ...
    replyComment(e, t) {
      this.inject("editor").setReplyComment(e, t);
    }
    editComment(e, t) {
      this.inject("editor").setEditComment(e, t);
    }
    editorShowLoading() {
    ...
    editorShowNotify(e, t) {
      this.inject("editor").showNotify(e, t);
    }
    editorResetState() {
      this.inject("editor").resetState();
    }
    showSidebar(e) {
      this.inject("sidebar").show(e);
    }
    hideSidebar() {
      this.inject("sidebar").hide();
    }
    checkAdmin(e) {
      return this.inject("checkers").checkAdmin(e);
    }
    checkCaptcha(e) {
      return this.inject("checkers").checkCaptcha(e);
    }
  }
  function Mt(...e) {
  ...
  const Rt = {
    ...
    useBackendConf: !0,
    preferRemoteConf: !1,
    listUnreadHighlight: !1,
    pvAdd: !0,
    fetchCommentsOnInit: !0,
    locale: "en",
    apiVersion: "",
    pluginURLs: [],
    markedReplacers: [],
  ...
  function Ut(e, t, n) {
    return {
      ...
      getApiToken: () => (null == t ? void 0 : t.getData().token),
      userInfo: (null == t ? void 0 : t.checkHasBasicUserInfo())
        ? {
            name: null == t ? void 0 : t.getData().name,
            email: null == t ? void 0 : t.getData().email,
          }
        : void 0,
      handlers: n,
    };
        ...
        d(this, "request", e =>
          h(this, null, function* () {
            ...
            const k =
              ...
              v = u && this.toQueryString(u),
              w = this.contentFormatters[d || "application/json"],
              $ = p || y.format;
            return this.customFetch(
              `${g || this.baseUrl || ""}${a}${v ? `?${v}` : ""}`,
              c(l({}, y), {
                headers: l(
                  l({}, y.headers || {}),
  ...
  class Ft extends Ot {
    constructor(e) {
      super({ baseUrl: e.baseURL, customFetch: (t, n) => Dt(e, t, n) }),
        d(this, "_opts"),
        (this._opts = e);
    }
    getUserFields() {
  ...
  class Wt {
    ...
    useBtn(e = "<div></div>") {
      return (
        (this.$btn = u(`<span class="atk-plug-btn">${e}</span>`)), this.$btn
      );
    }
    usePanel(e = "<div></div>") {
      return (this.$panel = u(e)), this.$panel;
    }
  ...
  class Nt {
    ...
    postSubmitAdd(e) {
      this.kit.useData().insertComment(e);
    }
  }
  class Ht extends Wt {
    constructor(e) {
      super(e),
        ...
        (this.defaultPreset = new Nt(this.kit));
      const t = () => this.do();
      this.kit.useMounted(() => {
        this.kit.useEvents().on("editor-submit", t);
      }),
        this.kit.useUnmounted(() => {
          this.kit.useEvents().off("editor-submit", t);
        });
    }
    registerCustom(e) {
      this.customs.push(e);
      ...
      return h(this, null, function* () {
        ...
        try {
          ...
          return (
            ...
            void this.kit
              .useEditor()
              .showNotify(`${T("commentFail")}: ${t.message || String(t)}`, "e")
          );
        } finally {
  ...
  class Vt extends Wt {
    ...
    move(e) {
      ...
      t.after(u('<div class="atk-editor-travel-placeholder"></div>'));
      const n = u("<div></div>");
      e.after(n),
        n.replaceWith(t),
  ...
  function Xt(e, t, n = '<span class="atk-error-title">Artalk Error</span>') {
  ...
  class Jt extends Wt {
      ...
      return h(this, null, function* () {
        ...
        try {
          ...
          return (
            ...
            Xt(
              this.$panel,
              `[${T("emoticon")}] ${T("loadFail")}: ${String(t)}`
            ),
            []
          );
        }
    ...
    initEmoticonsList() {
      (this.$grpWrap = u('<div class="atk-grp-wrap"></div>')),
        this.$panel.append(this.$grpWrap),
        this.emoticons.forEach((e, t) => {
          const n = u('<div class="atk-grp" style="display: none;"></div>');
          this.$grpWrap.append(n),
            ...
            e.items.forEach(t => {
              const s = u('<span class="atk-item"></span>');
              if (
                (n.append(s),
                t.key &&
        ...
        this.emoticons.length > 1 &&
          ((this.$grpSwitcher = u('<div class="atk-grp-switcher"></div>')),
  ...
  const en = ["png", "jpg", "jpeg", "gif", "bmp", "svg", "webp"];
  class tn extends Wt {
    constructor(e) {
      super(e),
    ...
    init() {
      (this.$imgUploadInput = document.createElement("input")),
        ...
        (this.$imgUploadInput.accept = en.map(e => `.${e}`).join(","));
      const e = this.useBtn(
    ...
    uploadImg(e) {
      return h(this, null, function* () {
        const t = /[^.]+$/.exec(e.name);
        if (!t || !en.includes(String(t[0]).toLowerCase())) return;
        if (!this.kit.useUser().checkHasBasicUserInfo())
          return void this.kit.useEditor().showNotify(T("uploadLoginMsg"), "w");
        let n = "\n";
        ...
        try {
          ...
          console.error(r),
            this.kit
              .useEditor()
              .showNotify(`${T("uploadFail")}: ${r.message}`, "e");
        }
        if (i && i.public_url) {
          let e = i.public_url;
          v(e) || (e = w({ base: this.kit.useConf().server, path: e })),
            this.kit
              .useEditor()
              .setContent(
          ...
          this.kit
            .useEditor()
            .setContent(this.kit.useUI().$textarea.value.replace(s, ""));
      });
    }
  }
  class nn extends Wt {
  ...
  const sn = [
    class extends Wt {
      constructor(e) {
        ...
        this.kit.useMounted(() => {
          const e = window.localStorage.getItem(zt) || "";
          "" !== e.trim() &&
    ...
    class extends Wt {
      constructor(e) {
        ...
        const t = ({ $input: e, field: t }) => {
          ...
          n = { name: T("nick"), email: T("email"), link: T("link") };
        this.kit.useMounted(() => {
      ...
      onUserInfoFetched(e) {
        ...
        e.is_login || this.kit.useUser().logout(),
          this.kit.useData().updateNotifies(e.notifies),
          this.kit.useUser().checkHasBasicUserInfo() &&
            !e.is_login &&
            (null == (t = e.user) ? void 0 : t.is_admin) &&
            this.kit.useCheckers().checkAdmin({ onSuccess: () => {} }),
          e.user &&
            e.user.link &&
    ...
    class extends Wt {
      ...
      adaptiveHeightByContent() {
        ...
        (this.kit.useUI().$textarea.style.height = "0px"),
          (this.kit.useUI().$textarea.style.height = `${this.kit.useUI().$textarea.scrollHeight + e}px`);
      }
    },
    Ht,
    class extends Wt {
      ...
      constructor(e) {
        super(e),
          ...
          this.kit.useEvents().on("mounted", () => {
            const e = this.kit.useDeps(Ht);
            if (!e) throw Error("SubmitPlug not initialized");
            const t = new Nt(this.kit);
            e.registerCustom({
        ...
        super(e),
          ...
          this.kit.useMounted(() => {
            ...
            e.registerCustom({
              ...
              post: e => {
                this.kit.useData().updateComment(e);
              },
            });
          });
      }
  ...
  class an {
    constructor(e) {
      ...
      this.opts
          ...
          e => {
            t && this.getEvents().trigger("unmounted"),
              ...
              (function (e) {
                const t = new Map();
                return (
                  t.set(tn, e.imgUpload),
                  t.set(Jt, e.emoticons),
                  t.set(nn, e.preview),
                  t.set(Vt, e.editorTravel),
                  sn.filter(e => !t.has(e) || !!t.get(e))
                );
              })(e).forEach(e => {
                const t = new rn(this);
                this.plugins.push(new e(t));
              }),
        ...
        this.events.on("editor-submitted", () => e.onSubmitted());
    }
    getPlugins() {
      return this.plugins;
    }
    ...
    clear() {
      (this.plugins = []),
        (this.events = new on()),
        this.openedPlug && this.closePluginPanel();
    }
    loadPluginUI() {
      (this.getEditor().getUI().$plugPanelWrap.innerHTML = ""),
        ...
        this.plugins.forEach(e => this.loadPluginItem(e));
    }
    loadPluginItem(e) {
      const t = e.$btn;
      if (!t) return;
      this.getEditor().getUI().$plugBtnWrap.appendChild(t),
        !t.onclick &&
          (t.onclick = () => {
            this.opts
              .getEditor()
              ...
              .forEach(e => e.classList.remove("active")),
              e !== this.openedPlug
                ? (this.openPluginPanel(e), t.classList.add("active"))
                : this.closePluginPanel();
          });
      const n = e.$panel;
      n &&
        ((n.style.display = "none"),
        this.getEditor().getUI().$plugPanelWrap.appendChild(n));
    }
    get(e) {
      return this.plugins.find(t => t instanceof e);
    }
    openPluginPanel(e) {
  ...
  const ln = "2.9.1";
  function cn(e) {
    const t = u('<span><span class="error-message"></span><br/><br/></span>');
    if (
      ((t.querySelector(".error-message").innerText =
        `${T("listLoadFailMsg")}\n${e.errMsg}`),
      e.retryFn)
    ) {
      const n = u(`<span style="cursor:pointer;">${T("listRetry")}</span>`);
  ...
  const dn = [
    e => {
      ...
      e.on("list-fetch", n => {
        ...
        const s = l(
          {
            offset: 0,
            limit: t.get().pagination.pageSize,
            flatMode: t.get().flatMode,
            paramsModifier: t.get().listFetchParamsModifier,
          },
          n
        );
        e.getData().setListLastFetch({ params: s });
        const i = {
          limit: s.limit,
          offset: s.offset,
          flat_mode: s.flatMode,
          page_key: t.get().pageKey,
          site_name: t.get().site,
        };
        s.paramsModifier && s.paramsModifier(i),
          e
            .getApi()
            .comments.getComments(l(l({}, i), e.getApi().getUserFields()))
            .then(({ data: t }) => {
              e.getData().setListLastFetch({ params: s, data: t }),
                e.getData().loadComments(t.comments),
                e.getData().updatePage(t.page),
                s.onSuccess && s.onSuccess(t),
                e.trigger("list-fetched", { params: s, data: t });
            })
            .catch(t => {
              const n = { msg: t.msg || String(t), data: t.data };
              throw (
                (s.onError && s.onError(n),
                e.trigger("list-failed", n),
                e.trigger("list-fetched", { params: s, error: n }),
                t)
              );
            })
            .finally(() => {
    ...
    e => {
      const t = e.inject("list");
      e.on("list-fetch", e => {
        0 === e.offset && Gt(!0, t.getEl());
      }),
        e.on("list-fetched", () => {
          Gt(!1, t.getEl());
        });
    ...
    e => {
      const t = e.inject("config");
      e.on("comment-rendered", n => {
        if (t.get().listUnreadHighlight) {
          const t = e.getData().getNotifies(),
            s = t.find(e => e.comment_id === n.getID());
          s
            ? (n.getRender().setUnread(!0),
              n.getRender().setOpenAction(() => {
                window.open(s.read_link),
                  e
                    .getData()
                    .updateNotifies(t.filter(e => e.comment_id !== n.getID()));
              }))
            : n.getRender().setUnread(!1);
        }
      }),
        e.on("list-goto", t => {
          const n = g("atk_notify_key");
          n &&
            e
              .getApi()
    ...
    e => {
      const t = e.inject("list"),
        n = e.inject("editorPlugs");
      let s;
      e.on("mounted", () => {
        (s = t.getEl().querySelector('[data-action="admin-close-comment"]')),
        ...
        e.on("page-loaded", e => {
          !0 === (null == e ? void 0 : e.admin_only)
            ? (null == n || n.getEvents().trigger("editor-close"),
              s && (s.innerText = T("openComment")))
            : (null == n || n.getEvents().trigger("editor-open"),
              s && (s.innerText = T("closeComment")));
        }),
        e.on("list-loaded", t => {
          e.editorResetState();
        });
    ...
    e => {
      ...
      e.on("list-loaded", () => {
        (() => {
          var n, s;
          const i = t.getEl().querySelector(".atk-comment-count .atk-text");
          if (!i) return;
          const r = p(
            T("counter", {
              count: `${Number(null == (s = null == (n = e.getData().getListLastFetch()) ? void 0 : n.data) ? void 0 : s.count) || 0}`,
            })
          );
          i.innerHTML = r.replace(
            /(\d+)/,
    ...
    e => {
      ...
      const s = () => {
        if (!n) return;
        const t = e.inject("user").getData();
        if (t.name && t.email) {
          n.classList.remove("atk-hide");
          const e = n.querySelector(".atk-text");
          e && (e.innerText = t.is_admin ? T("ctrlCenter") : T("msgCenter"));
        } else n.classList.add("atk-hide");
      };
      e.watchConf(["locale"], i => {
        (n = t.getEl().querySelector('[data-action="open-sidebar"]')),
          n &&
            ((n.onclick = () => {
              e.showSidebar();
            }),
    ...
    e => {
      ...
      let n = null;
      e.on("mounted", () => {
        n = t.getEl().querySelector(".atk-unread-badge");
      }),
    ...
    e => {
      const t = e.inject("list"),
        n = e.inject("config"),
        s = t => {
          n.update({ listFetchParamsModifier: t }), e.reload();
        },
        i = e => {
          !(function (e) {
            ...
            t.classList.add("atk-dropdown-wrap"),
              t.append(u('<span class="atk-arrow-down-icon"></span>'));
            let s = 0;
            const i = (e, t, n, i) => {
                i(),
                  (s = e),
              ...
              r = u('<ul class="atk-dropdown atk-fade-in"></ul>');
            n.forEach((e, t) => {
              const [n, o] = e,
                a = u('<li class="atk-dropdown-item"><span></span></li>'),
      ...
      e.watchConf(["listSort", "locale"], e => {
        const n = t.getEl().querySelector(".atk-comment-count");
        n &&
          (e.listSort
            ? i(n)
            : (function (e) {
                ...
                s.classList.remove("atk-dropdown-wrap"),
                  null == (t = s.querySelector(".atk-arrow-down-icon")) ||
                    t.remove(),
                  null == (n = s.querySelector(".atk-dropdown")) || n.remove();
              })({ $dropdownWrap: n }));
      });
    },
    e => {
      ...
      e.on("mounted", () => {
        ...
        e.on("unmounted", () => {
          window.removeEventListener("hashchange", s), e.off("list-loaded", i);
        });
    },
    e => {
      const t = e.inject("list");
      e.on("list-goto", n =>
        h(this, null, function* () {
          let s = e.getCommentNodes().find(e => e.getID() === n);
          if (!s) {
            const i = (yield e.getApi().comments.getComment(n)).data;
            t
              .getLayout({ forceFlatMode: !0 })
              .insert(i.comment, i.reply_comment),
              (s = e.getCommentNodes().find(e => e.getID() === n));
          }
          s && s.focus();
        })
      );
    ...
    e => {
      ...
      e.on("list-loaded", s => {
        const i = s.length <= 0;
        let r = t.getCommentsWrapEl().querySelector(".atk-list-no-comment");
        i
          ? r ||
            ((r = u('<div class="atk-list-no-comment"></div>')),
            (r.innerHTML = kt(n.get().noComment || e.$t("noComment"))),
            t.getCommentsWrapEl().appendChild(r))
          : null == r || r.remove();
      });
    },
    e => {
      const t = e.inject("list");
      e.on("mounted", () => {
        const e = t.getEl().querySelector(".atk-copyright");
        e &&
          (e.innerHTML = `Powered By <a href="https://artalk.js.org" target="_blank" title="Artalk v${ln}">Artalk</a>`);
      });
    },
    e => {
      const t = e.inject("list"),
    ...
    e => {
      ...
      e.on("list-loaded", () => {
        i();
        const r = t.getCommentsWrapEl().childNodes,
          o = r.length > 2 ? r[r.length - 2] : null;
        o &&
          ("IntersectionObserver" in window
            ? (t => {
                var r, o;
                const a =
                  (null == (o = (r = n.get()).scrollRelativeTo)
                    ? void 0
                    : o.call(r)) || null;
                (s = new IntersectionObserver(
                  ([t]) => {
                    t.isIntersecting && (i(), e.trigger("list-reach-bottom"));
                  },
                  { threshold: 0.9, root: a }
                )),
                  s.observe(t);
              })(o)
    ...
    e => {
      const t = e.inject("list"),
        ...
        s = () => {
          var e, s;
          const i =
            null == (s = (e = n.get()).scrollRelativeTo) ? void 0 : s.call(e);
          (i || window).scroll({ top: m(t.getEl(), i).top, left: 0 });
        };
      e.on("mounted", () => {
        e.on("list-goto-first", s);
      }),
        e.on("unmounted", () => {
          e.off("list-goto-first", s);
        });
    },
  ];
  let hn = !1;
  ...
  function mn(e, t, n, s, i) {
    var r, o;
    e.upCountEl
      ? (e.upCountEl.innerText = String(t))
      : e.upBtnEl && (e.upBtnEl.innerText = `${T("voteUp")} (${t})`),
      e.downCountEl
        ? (e.downCountEl.innerText = String(n))
        : e.downBtnEl && (e.downBtnEl.innerText = `${T("voteDown")} (${n})`),
      "boolean" == typeof s &&
        (null == (r = e.upBtnEl) ||
          r.classList.toggle(e.activeClass || "active", s)),
      "boolean" == typeof i &&
        (null == (o = e.downBtnEl) ||
          o.classList.toggle(e.activeClass || "active", i));
  }
  const fn = (e, t) => n => {
    n.preventDefault();
    const { state: s, pageId: i, httpApi: r } = t();
    i &&
      r.votes
        .createVote("page", i, e, l({}, r.getUserFields()))
        .then(({ data: e }) => {
          mn(s, e.up, e.down, e.is_up, e.is_down);
        })
        .catch(e => {
          window.alert(T("voteFail")), console.error("[ArtalkPageVote]", e);
        });
  };
  const kn = "ArtalkUser";
  class yn {
    constructor(e) {
      ...
      const t = JSON.parse(window.localStorage.getItem(kn) || "{}");
      this.data = {
        name: t.name || t.nick || "",
        email: t.email || "",
        link: t.link || "",
    ...
    update(e = {}) {
      Object.entries(e).forEach(([e, t]) => {
        ...
        window.localStorage.setItem(kn, JSON.stringify(this.data)),
  ...
  const wn = {
      ...
      body: e =>
        e.get("iframe")
          ...
          : (function (e) {
              const t = u(
                `<span><img class="atk-captcha-img" src="${e.get("img_data") || ""}">${T("captchaCheck")}</span>`
              );
              return (
    ...
    $n = {
      ...
      body: e => u(`<span>${T("adminCheck")}</span>`),
      onSuccess(e, t, n, s) {
  ...
  class bn {
    ...
    setYes(e) {
      const t = u(`<button data-action="confirm">${T("confirm")}</button>`);
      return (
        (t.onclick = this.onBtnClick(e)), this.$actions.appendChild(t), this
      );
    }
    setNo(e) {
      const t = u(`<button data-action="cancel">${T("cancel")}</button>`);
      return (
        (t.onclick = this.onBtnClick(e)), this.$actions.appendChild(t), this
      );
    }
  ...
  class En {
    ...
    check(e, t, n) {
      const s = this.opts.getLayers().create(`checker-${new Date().getTime()}`);
      s.show();
      const i = () => {
          s.destroy();
        },
    ...
    switch(e, t) {
      ...
      if (
        (this.stateUnmountFn &&
          ...
          null ==
            (s = null == (n = this.editor.getPlugins()) ? void 0 : n.get(Vt)) ||
            s.back()),
        "normal" !== e && t)
      ) {
        let n = t.$comment;
        this.editor.getOptions().getConf().get().flatMode ||
          (n = n.querySelector(".atk-footer")),
          null ==
            (r = null == (i = this.editor.getPlugins()) ? void 0 : i.get(Vt)) ||
            r.move(n);
        const s =
          null ==
          (a = (o = this.editor.getOptions().getConf().get()).scrollRelativeTo)
            ? void 0
            : a.call(o);
        Zt(this.editor.getUI().$el, !0, s);
        const c =
          null == (l = this.editor.getPlugins())
            ? void 0
            : l.getPlugins().find(t => t.editorStateEffectWhen === e);
        c &&
          c.editorStateEffect &&
          (this.stateUnmountFn = c.editorStateEffect(t.comment));
      }
      this.stateCurt = e;
    }
  }
  class Tn {
    ...
    getContentMarked() {
      return Lt(this.getContentFinal());
    }
    setContent(e) {
      var t;
      (this.ui.$textarea.value = e),
        null == (t = this.getPlugins()) ||
    ...
    showNotify(e, t) {
      !(function (e, t, n) {
        ...
        (s.querySelector(".atk-notify-content").innerHTML = p(t).replace(
          "\n",
          "<br/>"
        )),
          e.appendChild(s);
    ...
    submit() {
      const e = () => {
          var e;
          null == (e = this.getPlugins()) ||
            e.getEvents().trigger("editor-submit"),
            this.opts.getEvents().trigger("editor-submit");
        },
        t = this.opts.getConf().get().beforeSubmit;
      t ? t(this, e) : e();
    }
  }
  class An {
  ...
  function Rn() {
    return {
      init() {
        (Pn = document.body.style.overflow),
          (Mn = document.body.style.paddingRight);
      },
      unlock() {
        (document.body.style.overflow = Pn),
          (document.body.style.paddingRight = Mn);
      },
      lock() {
  ...
  class In {
    ...
    hideWrap(e) {
      this.items
        ...
        .length > 0 || ((this.$wrap.style.display = "none"), Rn().unlock());
    }
  }
  class Un {
    constructor() {
      d(this, "wrap", new In()), Rn().init();
    }
    getEl() {
        ...
        ? ((e = this.options),
          {
            ...
            insert: (t, n) => {
              qn(e, "prepend", t, n).scrollIntoView();
            },
          })
        : jn(this.options);
      var e;
      ...
      const r = () => {
        ...
        e.scrollable
          ...
          : (function (e) {
              if (!e.el) return;
              if (!e.max) return;
              if (e.el.classList.contains(Dn)) return;
              e.el.classList.add(Dn),
  ...
  function Wn(e) {
    if (((e.$headerNick = e.$el.querySelector(".atk-nick")), e.data.link)) {
      const t = u('<a target="_blank" rel="noreferrer noopener nofollow"></a>');
      (t.innerText = e.data.nick),
        (t.href = v(e.data.link) ? e.data.link : `https://${e.data.link}`),
  ...
  function zn(e) {
    ...
    if (t) {
      const s = u('<span class="atk-badge"></span>');
      (s.innerText = t.replace("管理员", T("admin"))),
    ...
    if (e.data.is_pinned) {
      const t = u(`<span class="atk-pinned-badge">${T("pin")}</span>`);
      e.$headerBadgeWrap.append(t);
    }
  }
  function Nn(e) {
  ...
  function Hn(e) {
    ...
    if (
      (t || ((t = u('<span class="atk-ua-wrap"></span>')), e.$header.append(t)),
      (t.innerHTML = ""),
      e.data.ip_region)
    ) {
      const n = u('<span class="atk-region-badge"></span>');
      (n.innerText = e.data.ip_region), t.append(n);
    }
    if (e.opts.uaBadge) {
      const { browser: n, os: s } = e.comment.getUserUA();
      if (String(n).trim()) {
        const e = u('<span class="atk-ua ua-browser"></span>');
        (e.innerText = n), t.append(e);
      }
      if (String(s).trim()) {
        const e = u('<span class="atk-ua ua-os"></span>');
  ...
  class Vn {
    constructor(e) {
      d(this, "opts"),
        ...
        (this.$el = u('<span class="atk-common-action-btn"></span>')),
          ...
          if (this.opts.confirm && !this.isMessaging) {
            ...
            if (!this.isConfirming)
              return (
                ...
                (this.$el.innerText =
                  this.opts.confirmText || T("actionConfirm")),
  ...
  function Qn(e) {
    e.opts.vote &&
      ((e.voteBtnUp = new Vn(
        () => `${T("voteUp")} (${e.data.vote_up || 0})`
      ).appendTo(e.$actions)),
      e.voteBtnUp.setClick(() => {
        e.comment.getActions().vote("up");
      }),
      e.opts.voteDown &&
        ((e.voteBtnDown = new Vn(
          () => `${T("voteDown")} (${e.data.vote_down || 0})`
        ).appendTo(e.$actions)),
  ...
  function Kn(e) {
    ...
    const t = new Vn({ text: T("reply") });
    t.appendTo(e.$actions),
      t.setClick(() => {
        e.opts.replyComment(e.data, e.$el);
      });
  }
  function Gn(e) {
    const t = new Vn({
      text: () => (e.data.is_collapsed ? T("expand") : T("collapse")),
      adminOnly: !0,
    });
    t.appendTo(e.$actions),
      t.setClick(() => {
  ...
  function Zn(e) {
    const t = new Vn({
      text: () => (e.data.is_pending ? T("pending") : T("approved")),
      adminOnly: !0,
    });
    t.appendTo(e.$actions),
      t.setClick(() => {
  ...
  function Yn(e) {
    const t = new Vn({
      text: () => (e.data.is_pinned ? T("unpin") : T("pin")),
      adminOnly: !0,
    });
    t.appendTo(e.$actions),
      t.setClick(() => {
  ...
  function Xn(e) {
    const t = new Vn({ text: T("edit"), adminOnly: !0 });
    t.appendTo(e.$actions),
      t.setClick(() => {
  ...
  const es = {
    Avatar: function (e) {
      ...
      if (((n.src = s ? s(e.data) : e.comment.getGravatarURL()), e.data.link)) {
        ...
        (s.href = v(e.data.link) ? e.data.link : `https://${e.data.link}`),
          s.append(n),
          t.append(s);
      } else t.append(n);
    },
        ...
        t.stopPropagation(),
          e.$content.classList.contains("atk-hide")
            ? ((e.$content.innerHTML = e.comment.getContentMarked()),
              ...
              Yt(e.$content),
              (n.innerText = T("collapse")))
            : ((e.$content.innerHTML = ""),
              e.$content.classList.add("atk-hide"),
              (n.innerText = T("expand")));
      });
    },
    ReplyAt: function (e) {
      e.opts.flatMode ||
        ...
        (e.opts.replyTo &&
          ...
          (e.$replyAt.querySelector(".atk-nick").innerText =
            `${e.opts.replyTo.nick}`),
          (e.$replyAt.onclick = () => {
    ...
    ReplyTo: function (e) {
      ...
      let n = Lt(e.opts.replyTo.content);
      e.opts.replyTo.is_collapsed && (n = `[${T("collapsed")}]`),
        (e.$replyTo.querySelector(".atk-content").innerHTML = n),
        e.$body.prepend(e.$replyTo);
    },
    Pending: function (e) {
      if (!e.data.is_pending) return;
      const t = u(`<div class="atk-pending">${T("pendingMsg")}</div>`);
      e.$body.prepend(t);
    },
    Actions: function (e) {
      Object.entries({
  ...
  class ts {
      ...
      On(
        {
          afterExpandBtnClick: () => {
            ...
            1 === e.length && Bn(e[0].getRender().$content);
          },
    ...
    heightLimitRemoveForChildren() {
      this.$childrenWrap && Bn(this.$childrenWrap);
    }
    playFadeAnim() {
      Yt(this.comment.getRender().$el);
    }
    playFadeAnimForBody() {
      Yt(this.comment.getRender().$body);
    }
    playFlashAnim() {
    ...
    getChildrenWrap() {
      return (
        this.$childrenWrap ||
          ((this.$childrenWrap = u('<div class="atk-comment-children"></div>')),
  ...
  class ns {
    ...
    vote(e) {
      ...
      this.getApi()
        ...
        .catch(e => {
          null == t || t.setError(T("voteFail")), console.error(e);
        });
    }
    adminEdit(e, t) {
      if (t.isLoading) return;
      t.setLoading(!0, `${T("editing")}...`);
      const n = l({}, this.data);
      "collapsed" === e
        ...
        this.getApi()
          ...
          .catch(e => {
            console.error(e), t.setError(T("editFail"));
          });
    }
    adminDelete(e) {
      e.isLoading ||
        (e.setLoading(!0, `${T("deleting")}...`),
        this.getApi()
          ...
          .catch(t => {
            console.error(t), e.setError(T("deleteFail"));
          }));
    }
    goToReplyComment() {
  ...
  class ss {
    constructor(e, t) {
      d(this, "$el"),
        ...
        (this.parent = null),
        (this.nestCurt = 1),
        (this.actionInstance = new ns(this)),
        (this.renderInstance = new ts(this));
    }
    render() {
    ...
    getGravatarURL() {
      return `${(e = { mirror: this.opts.gravatar.mirror, params: this.opts.gravatar.params, emailHash: this.data.email_encrypted }).mirror.replace(/\/$/, "")}/${e.emailHash}?${e.params.replace(/^\?/, "")}`;
      var e;
    }
    getContentMarked() {
      return Lt(this.data.content);
    }
    getDateFormatted() {
      var e, t;
  ...
  class rs {
    ...
    create(e) {
      return (
        ...
        (this.instance = new is({
          ...
          onClick: t =>
            h(this, null, function* () {
              e.getData().fetchComments({ offset: t });
            }),
          text: T("loadMore"),
        })),
        e.readMoreAutoLoad &&
    ...
    dispose() {
      this.onReachedBottom &&
        this.opt.getEvents().off("list-reach-bottom", this.onReachedBottom),
  ...
  class as {
    ...
    create(e) {
      return (
        (this.instance = new os(e.total, {
          pageSize: e.pageSize,
          onChange: t =>
            h(this, null, function* () {
              e.resetEditorState(),
                e.getData().fetchComments({
                  offset: t,
                  onSuccess: () => {
                    var t;
                    null == (t = e.onListGotoFirst) || t.call(e);
                  },
                });
            }),
        })),
  ...
  function ls(e) {
    const t = { offset: 0, total: 0 };
    return e
      ? ((t.offset = e.params.offset),
        e.data &&
          (t.total = e.params.flatMode ? e.data.count : e.data.roots_count),
        t)
      : t;
  }
  const cs = e => {
    let t = null;
    e.getConf().watchConf(["pagination", "locale"], n => {
      const s = e.getList(),
        i = e.getData();
      t && t.dispose(),
        (t = (function (e) {
          return e.pagination.readMore ? new rs() : new as();
        })(n));
      const { offset: r, total: o } = ls(i.getListLastFetch()),
        a = t.create(
          l(
            {
      ...
      s.getCommentsWrapEl().after(a), null == t || t.update(r, o);
    }),
      e.getEvents().on("list-loaded", n => {
        const { offset: s, total: i } = ls(e.getData().getListLastFetch());
        null == t || t.update(s, i);
      }),
      e.getEvents().on("list-fetch", n => {
        e.getData().getComments().length > 0 &&
          (null == t ? void 0 : t.getIsClearComments(n)) &&
          e.getData().clearComments();
      }),
      e.getEvents().on("list-failed", () => {
        var e;
        null == (e = null == t ? void 0 : t.showErr) ||
          e.call(t, T("loadFail"));
      }),
      e.getEvents().on("list-fetch", e => {
        null == t || t.setLoading(!0);
      }),
      e.getEvents().on("list-fetched", ({ params: e }) => {
  ...
  class ds {
    ...
    getLayout({ forceFlatMode: e } = {}) {
      return new _n({
        $commentsWrap: this.$commentsWrap,
        nestSortBy: this.opts.getConf().get().nestSort,
        nestMax: this.opts.getConf().get().nestMax,
        flatMode:
          "boolean" == typeof e ? e : this.opts.getConf().get().flatMode,
        createCommentNode: (t, n) => {
          const s = (function (e, t, n) {
            const s = e.getConf().get(),
              i = new ss(t, {
                onAfterRender: () => {
                  e.getEvents().trigger("comment-rendered", i);
                },
                onDelete: t => {
                ...
                replyTo: n,
                flatMode:
                  "boolean" == typeof (null == e ? void 0 : e.forceFlatMode)
                    ? null == e
                      ? void 0
                      : e.forceFlatMode
                    : s.flatMode,
                ...
                avatarURLBuilder: s.avatarURLBuilder,
                scrollRelativeTo: s.scrollRelativeTo,
                vote: s.vote,
                voteDown: s.voteDown,
                uaBadge: s.uaBadge,
                ...
                editComment: e.editComment,
              });
            return i.render(), i;
          })(l({ forceFlatMode: e }, this.opts), t, n);
    ...
    initCrudEvents() {
      this.opts.getEvents().on("list-load", e => {
        this.getLayout().import(e);
      }),
        this.opts.getEvents().on("list-loaded", e => {
          0 === e.length &&
            ((this.commentNodes = []), (this.$commentsWrap.innerHTML = ""));
        }),
        this.opts.getEvents().on("comment-inserted", e => {
          var t;
          const n = e.rid
            ? null == (t = this.commentNodes.find(t => t.getID() === e.rid))
              ...
              : t.getData()
            : void 0;
          this.getLayout().insert(e, n);
        }),
        this.opts.getEvents().on("comment-deleted", e => {
        ...
        this.opts.getEvents().on("comment-updated", e => {
          const t = this.commentNodes.find(t => t.getID() === e.id);
          t && t.setData(e);
        });
    }
  ...
  class hs {
        ...
        this.authCheck({ onSuccess: () => this.show(e) }),
          (this.animTimer = setTimeout(() => {
            ...
            (this.animTimer = void 0),
              ...
              null == (t = (e = this.opts).onShow) || t.call(e);
          }, 100));
      });
    }
    hide() {
    ...
    authCheck(e) {
      return h(this, null, function* () {
        const t = (yield this.opts
          .getApi()
          .user.getUserStatus(l({}, this.opts.getApi().getUserFields()))).data;
        t.is_admin &&
          !t.is_login &&
          ((this.refreshWhenShow = !0),
      ...
      this.layer ||
        ...
        this.layer.setOnAfterHide(() => {
          ...
          this.animTimer && clearTimeout(this.animTimer),
            (this.$el.style.transform = ""),
            null == (t = (e = this.opts).onHide) || t.call(e);
        }));
    }
    createIframe(e) {
      const t = u(
        ...
        n = w({ base: this.opts.getConf().get().server, path: "/sidebar/" }),
        s = {
    ...
    getDarkMode() {
      return "auto" === this.opts.getConf().get().darkMode
  ...
  const us = [
      ...new Set([
        e => {
          e.provide("data", e => new An(e), ["events"]),
            e.on("mounted", () => {
              e.getConf().fetchCommentsOnInit &&
                e.getData().fetchComments({ offset: 0 });
            });
        },
        e => {
          e.provide(
        ...
        e => {
          e.provide(
            "editor",
            (t, n) => {
              const s = new Tn({ getEvents: () => t, getConf: () => n });
              return e.getEl().appendChild(s.getEl()), s;
            },
            ["events", "config"]
          );
        },
          ...
          e.provide(
            ...
            (t, n, s, i, r) => {
              const o = new ds({
                ...
                getConf: () => s,
                getData: () => i,
                replyComment: (e, t) => r.setReplyComment(e, t),
                editComment: (e, t) => r.setEditComment(e, t),
                resetEditorState: () => r.resetState(),
                onListGotoFirst: () => e.listGotoFirst(),
              });
              return e.getEl().appendChild(o.getEl()), o;
            },
          ...
          e.provide(
            ...
            (t, n, s, i, r) => {
              const o = new En({
                ...
                onReload: () => e.reload(),
                getCaptchaIframeURL: () =>
                  `${r.get().server}/api/v2/captcha/?t=${+new Date()}`,
              });
              return (
                n.add("need_captcha", e => o.checkCaptcha(e)),
                n.add("need_login", () => o.checkAdmin({})),
                o
              );
            },
        ...
        e => {
          e.provide("layers", () => {
            const t = new Un();
            return (
              document.body.appendChild(t.getEl()),
              e.on("unmounted", () => {
                null == t || t.destroy();
              }),
              t
              ...
              const c = new hs({
                onShow: () => {
                  setTimeout(() => {
                    ...
                    t.trigger("sidebar-show");
                },
                onHide: () => {
                  s.resetState(), t.trigger("sidebar-hide");
                },
                getCheckers: () => i,
                getApi: () => r,
                getConf: () => o,
      ...
      e => {
        e.watchConf(["imgLazyLoad", "markedOptions"], e => {
          !(function (e) {
            try {
              if (!Ie.name) return;
            } catch (n) {
            ...
            t.setOptions(
              l(
                l({ renderer: $t({ imgLazyLoad: e.imgLazyLoad }) }, Tt),
                e.markedOptions
              )
            ),
              (Ct = t);
          })({ markedOptions: e.markedOptions, imgLazyLoad: e.imgLazyLoad });
        }),
          e.watchConf(["markedReplacers"], e => {
            var t;
            e.markedReplacers && ((t = e.markedReplacers), (St = t));
          });
      },
      e => {
        e.provide(
          ...
          (t, n, s, i, r, o) => {
            const a = new an({
              ...
              getData: () => i,
              getCheckers: () => r,
              onSubmitted: () => e.trigger("editor-submitted"),
            });
            return t.setPlugins(a), a;
          },
          ["editor", "config", "user", "data", "checkers", "api"]
        );
      },
      e => {
        const t = e.inject("user"),
          n = () => {
            var n;
            (n = t.getData().is_admin),
              (function (e) {
                const t = [];
                e.$root
      ...
      e => {
        const t = e.inject("list");
        e.watchConf(["apiVersion", "versionCheck"], e => {
          e.apiVersion &&
            e.versionCheck &&
            !hn &&
            (function (e, t, n) {
              ...
              if (0 === s) return;
              const i = u(
                  `<div class="atk-version-check-notice">${T("updateMsg", { name: T(s < 0 ? "client" : "server") })} <span class="atk-info">${T("currentVersion")}: ${T("client")} ${t} / ${T("server")} ${n}</span></div>`
                ),
                r = u(`<span class="atk-ignore-btn">${T("ignore")}</span>`);
              (r.onclick = () => {
                i.remove(), (hn = !0);
              }),
                i.append(r),
                e.getEl().parentElement.prepend(i);
            })(t, ln, e.apiVersion);
        });
      },
      e => {
        ...
        let s;
        const i = t => {
          const i = [e.getEl(), n.getEl()];
          un || (un = window.matchMedia("(prefers-color-scheme: dark)")),
            "auto" === t
              ? (s ||
                  ((s = e => pn(i, e.matches)),
                  un.addEventListener("change", s)),
                pn(i, un.matches))
              : (s && (un.removeEventListener("change", s), (s = void 0)),
                pn(i, t));
        };
        e.watchConf(["darkMode"], e => i(e.darkMode)),
          e.on("created", () => i(t.get().darkMode)),
          e.on("unmounted", () => {
            s && (null == un || un.removeEventListener("change", s)),
              (s = void 0);
          });
      },
      e => {
        ...
        let n,
          s = {};
        e.watchConf(["pageVote"], e => {
          const t = l(
            l({}, gn),
            "object" == typeof e.pageVote ? e.pageVote : {}
          );
          null == n || n(),
            e.pageVote &&
              ((s = (function (e, t, n, s) {
                ...
                const o = l({}, e);
                return (
                  (o.upBtnEl = document.querySelector(t.upBtnEl)),
                  (o.downBtnEl = document.querySelector(t.downBtnEl)),
                  (o.upCountEl = document.querySelector(t.upCountEl)),
                  (o.downCountEl = document.querySelector(t.downCountEl)),
                  (o.activeClass = t.activeClass),
                  (o.voteUpHandler = n),
                  (o.voteDownHandler = s),
                  null == (i = o.upBtnEl) || i.addEventListener("click", n),
                  null == (r = o.downBtnEl) || r.addEventListener("click", s),
                  o
                );
              })(s, t, a, c)),
              (n = () =>
                (s = (function (e) {
                  ...
                  return (
                    e.voteUpHandler &&
                      (null == (t = e.upBtnEl) ||
                        t.removeEventListener("click", e.voteUpHandler)),
                    e.voteDownHandler &&
                      (null == (n = e.downBtnEl) ||
                        n.removeEventListener("click", e.voteDownHandler)),
                    {}
                  );
                })(s))));
        }),
          e.on("unmounted", () => {
            null == n || n(), e.off("list-fetched", r);
          }),
          e.on("list-fetched", r);
        let i = 0;
        function r({ data: n }) {
          t.get().pageVote &&
            (function (e) {
              return e.upBtnEl || e.downBtnEl || e.upCountEl || e.downCountEl;
            })(s) &&
            n &&
            (i !== n.page.id
              ? ((i = n.page.id),
                mn(s, n.page.vote_up, n.page.vote_down, !1, !1),
                (function (e, t, n) {
                  n.votes
                    .getVote("page", t)
                    .then(({ data: t }) => {
                      mn(e, t.up, t.down, t.is_up, t.is_down);
                    })
                    .catch(e => {
                      console.error("[ArtalkPageVote]", e);
                    });
                })(s, i, e.getApi()))
              : mn(s, n.page.vote_up, n.page.vote_down));
        }
        const o = () => {
            var t;
            return {
              state: s,
              pageId:
                (null == (t = e.getData().getPage()) ? void 0 : t.id) || 0,
              httpApi: e.getApi(),
            };
          },
          a = fn("up", o),
  ...
  function ms(e, t) {
    return h(this, null, function* () {
      ...
      const s = new Set(),
        i = e => {
          e.forEach(e => {
            "function" == typeof e && (s.has(e) || (e(t, gs.get(e)), s.add(e)));
          });
        };
      i(ps);
      const { data: r } = yield t
        .getApi()
        .conf.conf()
        .catch(n => {
          throw (
            (((e, t = {}) => {
              var n;
              const s = e.inject("list"),
                i = e.inject("user"),
                r = e.inject("config"),
                o = t.err;
              if (!o) throw new Error("MountError: `err` is required");
              let a = "";
              if (null == (n = o.data) ? void 0 : n.err_no_site) {
                const e = {
                  create_name: r.get().site,
                  create_urls: `${window.location.protocol}//${window.location.host}`,
                };
                a = `sites|${JSON.stringify(e)}`;
              }
              cn({
                $err: s.getEl(),
                errMsg: o.msg || String(o),
                errData: o.data,
                retryFn: () => {
                  var e;
                  return null == (e = t.onRetry) ? void 0 : e.call(t);
                },
                onOpenSidebar: i.getData().is_admin
                  ? () => e.showSidebar({ view: a })
                  : void 0,
              });
            })(t, { err: n, onRetry: () => ms(e, t) }),
            n)
          );
        });
      let o = c(l({}, e), {
        apiVersion: null == (n = r.version) ? void 0 : n.version,
      });
      const a = (function (e) {
        const t = [
          "el",
      ...
      (o = o.preferRemoteConf ? Mt(o, a) : Mt(a, o)),
        t.updateConf(o),
        o.pluginURLs &&
          (yield (function (e, t) {
            return h(this, null, function* () {
  ...
  function fs({ keys: e, effect: t, getConf: n, getEvents: s }) {
    let i = null;
    const r = () => {
      const s = (() => {
        const t = n(),
      ...
      var r, o;
      (null == i ||
        ((r = i), (o = s), !(JSON.stringify(r) === JSON.stringify(o)))) &&
        ((i = s), t(s));
    };
    s().on("mounted", r), s().on("updated", r);
  }
  class ks {
    constructor(e) {
      d(this, "ctx");
      const t = (function (e) {
        let t;
        if ("string" == typeof e.el) {
          const n = document.querySelector(e.el);
          if (!n) throw new Error(`Element "${e.el}" not found.`);
          t = n;
        } else {
      ...
      t.classList.add("artalk"),
        (t.innerHTML = ""),
        1 == e.darkMode && t.classList.add("atk-dark-mode");
      const n = (this.ctx = new Pt(t));
      (e => {
        e.provide("events", () => new on());
      })(n),
        (e => {
          let t = It({}, !0);
          e.provide(
            ...
            e => {
              ...
              return (
                e.on("mounted", () => (n = !0)),
                {
                  ...
                  get: () => t,
                  update: s => {
                    (t = Mt(t, It(s, !1))), n && e.trigger("updated", t);
                  },
                }
              );
            },
      ...
      (() => {
        h(this, null, function* () {
          yield ms(e, n), n.trigger("mounted");
        });
      })();
    }
    getConf() {
  ...
  const ys = ks.init,
    vs = ks.use,
    ws = ks.loadCountWidget;
  (e.Defaults = Rt),
    (e.default = ks),
    (e.init = ys),
    (e.loadCountWidget = ws),
    (e.use = vs),
